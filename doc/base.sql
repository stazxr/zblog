...
INSERT INTO permission (ID, PID, PERM_NAME, PERM_TYPE, PERM_CODE, PERM_LEVEL, COMPONENT_NAME, COMPONENT_PATH, ROUTER_PATH, ICON, SORT, CACHE, HIDDEN, I_FRAME, ENABLED, DELETED, VERSION, CREATE_USER, CREATE_TIME, CREATE_DATE, UPDATE_USER, UPDATE_TIME) VALUES (2, 1, '用户管理', 2, 'userPage', 3, 'User', 'admin/system/user/index', 'user', 'peoples', 11, 1, 1, 0, 1, 0, 1, 'admin', '2021-06-10 00:02:58', '2021-06-10', 'admin', '2022-09-13 08:41:43');
...
INSERT INTO permission (ID, PID, PERM_NAME, PERM_TYPE, PERM_CODE, PERM_LEVEL, COMPONENT_NAME, COMPONENT_PATH, ROUTER_PATH, ICON, SORT, CACHE, HIDDEN, I_FRAME, ENABLED, DELETED, VERSION, CREATE_USER, CREATE_TIME, CREATE_DATE, UPDATE_USER, UPDATE_TIME) VALUES (1569026573775511554, 4, '查询权限编码列表', 3, 'queryPermCodes', 2, null, null, null, '', 99999, null, null, null, 1, 1, 1, 'admin', '2022-09-12 02:14:20', '2022-09-12', 'admin', '2022-09-12 15:24:58');
