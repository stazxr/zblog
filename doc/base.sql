...
CREATE TABLE `user` (
  ...
  UNIQUE KEY `KEY_TELEPHONE` (`TELEPHONE`),
  UNIQUE KEY `KEY_QQ` (`QQ`)
...
CREATE TABLE `permission` (
  ...
  `PERM_PATH` VARCHAR(500) NOT NULL DEFAULT '' COMMENT '权限路径',
...
CREATE TABLE `router` (
  ...
  `LEVEL` TINYINT(1) NOT NULL COMMENT '访问级别: 1-公开权限;2-公共权限;3-受控权限',
  `URL` VARCHAR(100) NOT NULL COMMENT '路由链接',
...
INSERT INTO dict (ID, NAME, `KEY`, VALUE, PID, TYPE, SORT, `DESC`, LOCKED, `UNIQUE`, ENABLED, DELETED, VERSION, CREATE_USER, CREATE_TIME, CREATE_DATE, UPDATE_USER, UPDATE_TIME) VALUES (9, '日历类型', null, null, null, 1, 4, '日历类型', 1, 1, 1, 0, 1, 'SYSTEM', '2022-04-12 19:48:00', '2022-04-12', '', '');
INSERT INTO dict (ID, NAME, `KEY`, VALUE, PID, TYPE, SORT, `DESC`, LOCKED, `UNIQUE`, ENABLED, DELETED, VERSION, CREATE_USER, CREATE_TIME, CREATE_DATE, UPDATE_USER, UPDATE_TIME) VALUES (10, '节假日', 'calendarType', '0', 9, 2, 1, '', 1, 0, 1, 0, 1, 'SYSTEM', '2022-04-12 19:48:00', '2022-04-12', '', '');
INSERT INTO dict (ID, NAME, `KEY`, VALUE, PID, TYPE, SORT, `DESC`, LOCKED, `UNIQUE`, ENABLED, DELETED, VERSION, CREATE_USER, CREATE_TIME, CREATE_DATE, UPDATE_USER, UPDATE_TIME) VALUES (11, '工作日', 'calendarType', '1', 9, 2, 2, '', 1, 0, 1, 0, 1, 'SYSTEM', '2022-04-12 19:48:00', '2022-04-12', '', '');
