...
CREATE TABLE `visitor` (
  ...
  `BROWSER_NAME` VARCHAR(100) NOT NULL COMMENT '浏览器名称',
  `PROVINCE` VARCHAR(100) NOT NULL COMMENT '省份',
  `AREA_CODE` VARCHAR(50) NOT NULL COMMENT '地域编码',
  `VERSION` INT(11) NOT NULL DEFAULT 1 COMMENT '乐观锁',
  `CREATE_USER` VARCHAR(20) NOT NULL COMMENT '创建用户',
  `CREATE_TIME` VARCHAR(20) NOT NULL COMMENT '创建时间',
  `CREATE_DATE` VARCHAR(20) NOT NULL COMMENT '创建日期',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='网站总访问量';

/*Data for the table `visitor_count` */
INSERT INTO visitor_count (WEB_COUNT) VALUES (0);
