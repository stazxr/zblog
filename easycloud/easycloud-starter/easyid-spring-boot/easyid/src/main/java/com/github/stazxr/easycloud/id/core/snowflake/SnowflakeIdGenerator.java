package com.github.stazxr.easycloud.id.core.snowflake;

import com.github.stazxr.easycloud.id.core.BaseWorkIdIdGenerator;
import com.github.stazxr.easycloud.id.EasyIdException;
 ...
 * @since 2021-12-19
 */
public class SnowflakeIdGenerator extends BaseWorkIdIdGenerator {
    /**
     * 开始时间戳
     */
    ...
    public Long nextId() {
        ...
        try {
            ...
            if (currentTime < lastTime) {
                // 时钟被回拨，直接拒绝服务
                throw new EasyIdException("Clock go back, refused generator guid service.");
            }
