...
CREATE TABLE website_config (
  ...
  WEBSITE_AVATAR VARCHAR(500) DEFAULT NULL COMMENT '作者头像',
...
CREATE TABLE `comment` (
  ...
  `PARENT_ID` BIGINT DEFAULT 0 COMMENT '所属一级评论ID（0=一级评论）',
  ...
  `UPDATE_TIME` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`ID`),
  KEY `idx_comment_object_type_status_parent_time` (`OBJECT_ID`, `TYPE`, `STATUS`, `PARENT_ID`, `CREATE_TIME`),
