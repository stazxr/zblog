...
CREATE TABLE website_config (
  ...
  WEBSITE_TITLE VARCHAR(200) DEFAULT NULL COMMENT '网站默认标题',
  ...
  WEBSITE_AVATAR VARCHAR(50) DEFAULT NULL COMMENT '作者头像',
  WEBSITE_SIGNATURE VARCHAR(124) DEFAULT NULL COMMENT '网站签名',
  -- SEO
  WEBSITE_KEYWORDS VARCHAR(500) DEFAULT NULL COMMENT '网站关键词',
  WEBSITE_DESCRIPTION VARCHAR(1000) DEFAULT NULL COMMENT '网站描述',
  -- 网站信息
  WEBSITE_CREATE_TIME DATE DEFAULT NULL COMMENT '网站创建日期',
...
INSERT INTO website_config (ID, WEBSITE_NAME, WEBSITE_TITLE, WEBSITE_LOGO, WEBSITE_FAVICON, WEBSITE_AUTHOR, WEBSITE_SIGNATURE, WEBSITE_KEYWORDS, WEBSITE_DESCRIPTION, WEBSITE_CREATE_TIME, WEBSITE_ICP_NO, WEBSITE_POLICE_NO, FOOTER_BACKGROUND, FONT_URL, STATISTICS_CODE, VERSION) VALUES (1, 'Z-BLOG', 'Z-BLOG', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1);
...
INSERT INTO website_link_config (ID, LINK_NAME, LINK_TYPE, LINK_URL, LINK_ICON, SORT, ENABLED) VALUES (1, '网站文档', 'DOCUMENT', NULL, NULL, 1, 1);
