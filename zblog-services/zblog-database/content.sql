...
CREATE TABLE website_config (
  ...
  WEBSITE_TITLE VARCHAR(200) DEFAULT NULL COMMENT '网站标题',
  WEBSITE_SUBTITLE VARCHAR(255) DEFAULT NULL COMMENT '网站副标题',
  WEBSITE_INTRO VARCHAR(500) DEFAULT NULL COMMENT '网站介绍',



  WEBSITE_AUTHOR VARCHAR(50) DEFAULT NULL COMMENT '作者名称',
  WEBSITE_SIGNATURE VARCHAR(124) DEFAULT NULL COMMENT '网站签名（页面展示）',
  WEBSITE_CREATE_TIME VARCHAR(20) DEFAULT NULL COMMENT '建站时间',
  WEBSITE_RECORD_NO VARCHAR(20) DEFAULT NULL COMMENT '备案号',

  DOCUMENT_URL VARCHAR(500) DEFAULT NULL COMMENT '网站文档地址',
  GITHUB_URL VARCHAR(1000) DEFAULT NULL COMMENT 'GITHUB地址',
  GITEE_URL VARCHAR(1000) DEFAULT NULL COMMENT 'GITEE地址',

  FOOTER_BACKGROUND VARCHAR(500) DEFAULT NULL COMMENT '页脚背景图',



  WEBSITE_LOGO VARCHAR(512) DEFAULT NULL COMMENT '网站Logo',
  WEBSITE_AVATAR VARCHAR(512) DEFAULT NULL COMMENT '站长头像',
  ...
  SEO_AUTHOR VARCHAR(100) DEFAULT NULL COMMENT '作者',
  ICP_NUMBER VARCHAR(100) DEFAULT NULL COMMENT '备案号',
  PUBLIC_SECURITY_NUMBER VARCHAR(100) DEFAULT NULL COMMENT '公安备案号',
  HOME_TITLE VARCHAR(200) DEFAULT NULL COMMENT '首页标题',
  HOME_NOTICE VARCHAR(500) DEFAULT NULL COMMENT '首页公告',
  THEME_NAME VARCHAR(50) DEFAULT NULL COMMENT '主题名称',
  PRIMARY_COLOR VARCHAR(20) DEFAULT NULL COMMENT '主题颜色',
  FONT_ENABLE TINYINT DEFAULT 0 COMMENT '是否启用字体',
  FONT_NAME VARCHAR(50) DEFAULT NULL COMMENT '字体名称',
  FONT_URL VARCHAR(512) DEFAULT NULL COMMENT '字体地址',
  CDN_ENABLE TINYINT DEFAULT 0 COMMENT '是否启用CDN',
  CDN_URL VARCHAR(512) DEFAULT NULL COMMENT 'CDN地址',
  QQ VARCHAR(50),
  EMAIL VARCHAR(100),
  STATISTIC_CODE TEXT COMMENT '统计代码',
  ABOUT_ME TEXT COMMENT '关于本站',
