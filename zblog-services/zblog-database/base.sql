...
CREATE TABLE `user` (
  ...
  `HEAD_IMG_URL` VARCHAR(1000) DEFAULT '' COMMENT '头像链接',
...
INSERT INTO `zblog`.`dict` (`ID`, `PID`, `DICT_NAME`, `DICT_TYPE`, `DICT_KEY`, `DICT_VALUE`, `DICT_SORT`, `DICT_DESC`, `ENABLED`, `DELETED`, `VERSION`, `CREATE_USER`, `CREATE_TIME`, `UPDATE_USER`, `UPDATE_TIME`) VALUES (4064554887222919168, 4064554565263949824, '系统用户', 2, 'USER_TYPE_CONFIG', '0', 1, NULL, 1, 0, 1, 2, '2025-12-24 00:50:00', NULL, NULL);
INSERT INTO `zblog`.`dict` (`ID`, `PID`, `DICT_NAME`, `DICT_TYPE`, `DICT_KEY`, `DICT_VALUE`, `DICT_SORT`, `DICT_DESC`, `ENABLED`, `DELETED`, `VERSION`, `CREATE_USER`, `CREATE_TIME`, `UPDATE_USER`, `UPDATE_TIME`) VALUES (4064554958014382080, 4064554565263949824, '普通用户', 2, 'USER_TYPE_CONFIG', '1', 2, NULL, 1, 0, 1, 2, '2025-12-24 00:50:17', NULL, NULL);
INSERT INTO `zblog`.`dict` (`ID`, `PID`, `DICT_NAME`, `DICT_TYPE`, `DICT_KEY`, `DICT_VALUE`, `DICT_SORT`, `DICT_DESC`, `ENABLED`, `DELETED`, `VERSION`, `CREATE_USER`, `CREATE_TIME`, `UPDATE_USER`, `UPDATE_TIME`) VALUES (4064555052583354368, 4064554565263949824, '管理员用户', 2, 'USER_TYPE_CONFIG', '2', 3, NULL, 1, 0, 1, 2, '2025-12-24 00:50:40', NULL, NULL);
...
CREATE TABLE `user_login_log` (
  ...
  INDEX ULL_UID_SUCCESS_TIME (`USER_ID`, `IS_SUCCESS`, `LOGIN_TIME` DESC)
