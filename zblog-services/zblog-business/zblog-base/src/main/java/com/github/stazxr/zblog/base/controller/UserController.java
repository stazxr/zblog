...
public class UserController {
    ...
    public Result queryUserListByPage(UserQueryDto queryDto) {
...
//    @ApiVersion(group = { BaseConst.ApiVersion.V_4_0_0 })
//    @Router(name = "查询用户列表（公共）", code = "pageUserListOfCommon", level = RouterLevel.PUBLIC)
...
//    })
//    @ApiVersion(group = { BaseConst.ApiVersion.V_4_0_0 })
//    @Router(name = "查询用户详情", code = "queryUserDetail", level = RouterLevel.PUBLIC)
