...
import com.github.stazxr.zblog.bas.jexl.function.ArithmeticHandler;
import com.github.stazxr.zblog.bas.jexl.function.ListHandler;
...
public class ExpressionUtils {
    ...
    public static String executeScript(String script) {
        try {
            ...
            ListHandler.removeKeys();
            ListHandler.removeRankKeys();
            ListHandler.removeOriginData();
        }
    }
    ...
    public static String executeScript(String script, List<Map<String, Object>> dataList, Map<String, String> varMap, Map<String, Class<?>> custom) {
        try {
            ...
            ListHandler.setOriginData(dataList);
    ...
    private static void setFunctionObject(JexlContext context, Map<String, Class<?>> custom) {
        ...
        context.set("List", ListHandler.class);
        context.set("Arithmetic", ArithmeticHandler.class);
